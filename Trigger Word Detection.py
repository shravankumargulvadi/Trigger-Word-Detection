...
get_ipython().set_next_input('After completing this assignment, perhaps you can also extend it to run on your laptop so that every time you say "activate" it starts up your favorite app, or turns on a network connected lamp in your house, or triggers some other event');get_ipython().run_line_magic('pinfo', 'event')
...
plt.plot(y[0])
Out[26]:
[<matplotlib.lines.Line2D at 0x7faa5c63ab00>]
